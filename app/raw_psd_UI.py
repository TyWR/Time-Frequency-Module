...
class Ui_RawPSDWindow(object):
    def setupUi(self, Dialog):
        ...
        self.lowerWindowLayout.setSpacing(0)
        ...
        self.displayLog.setMinimumSize(QtCore.QSize(0, 25))
        self.displayLog.setMaximumSize(QtCore.QSize(16777215, 25))
        self.displayLog.setObjectName("displayLog")
        self.verticalLayout.addWidget(self.displayLog)
        ...
        self.lowerWindowLayout.setStretch(1, 2)
