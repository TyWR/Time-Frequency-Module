...
class Ui_MenuWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cutButton.setMinimumSize(QtCore.QSize(130, 25))
        self.cutButton.setMaximumSize(QtCore.QSize(130, 25))
        self.cutButton.setObjectName("cutButton")
        self.horizontalLayout_6.addWidget(self.cutButton)
        self.enableBatching = QtWidgets.QCheckBox(self.centralwidget)
        self.enableBatching.setObjectName("enableBatching")
        self.horizontalLayout_6.addWidget(self.enableBatching)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Import Data"))
        self.pathButton.setText(_translate("MainWindow", "Choose Path"))
        self.cutButton.setText(_translate("MainWindow", "Cut into Epochs"))
        self.enableBatching.setText(_translate("MainWindow", "Enable Batching "))
